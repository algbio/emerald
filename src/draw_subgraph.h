...
template<class K>
std::string draw_subgraph(const int64_t IDX, const int64_t n, const int64_t m, const Dag &d, const std::vector<std::vector<K>> &ratios, K alpha, const std::string &a, const std::string &b) {
